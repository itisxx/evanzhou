! function (a) {
    ...
    function d() {
        ...
        if (navigator.plugins && "object" == typeof navigator.plugins["Shockwave Flash"]) {
            ...
            if (a = new window.ActiveXObject("ShockwaveFlash.ShockwaveFlash"), a && (b = a.GetVariable(
                    "$version"))) return b
        } catch (c) {}
        return ""
    }
        ...
        k = function (a, b, c) {
            function d() {
                if ("" === pa.innerHTML || pa.className !== oa) na = 1;
                    ...
                    na = 0 === ca.width || null === a.offsetParent || 0 === a.clientHeight ? -1 : null === pa.offsetParent ||
                        0 === pa.clientHeight ? 1 : 0
                }
                return na
            }

            function k(a) {
                return Aa = x(a), [$(H, ja, 21), $(I, ba.getAutostart(), 11), $(J, fa, 21), $(Y, ga, 28), $(Z,
                    ha, 28), $(U, ba.html5Mode(), 10), $(O, ca.bucket, 21), $(V, Aa, 101), $(L, w(a),
                    20), $(X, d(), 100)]
            }
            ...
            function q(a) {
                return function (b) {
                    if (!za) {
                        var c = qa[a];
                        (a !== va || (b = b.metadata || b, c && (b.width = b.width || c.width, b.height = b
                                .height || c.height, b.duration = b.duration || c.duration), !ba.html5Mode() ||
                            100 !== b.duration && 0 !== b.duration || 0 !== b.width || 0 !== b.height)) &&
                        (qa[a] = b, a === ua && (c || (xa = 0), ya = ba.getPosition()), qa[ua] && qa[va] &&
                            qa[wa] && (ra || (ra = !0, B())))
                    }
                }
            }
            ...
            function y(a) {
                ...
                var m = qa[va] || {},
                    n = 0 | m.width,
                    o = 0 | m.height;
                return 0 === n && 0 === o ? "rtmp" === k ? g : h : 320 >= n ? b : 640 >= n ? c : 1280 >= n ? d :
                    e
            }

            function z(a) {
                a = a || ba.getPlaylistItem(), ga = A(12), da.calculate(), ta.track(ia, E, [$(W, l(), 22), $(R,
                    ca.height, 22), $(Q, ca.width, 23)].concat(m(a)))
            }

            function A(a) {
                return new Array(a + 1).join((Math.random().toString(36) + "00000000000000000").slice(2, 18)).slice(
                    0, a)
            }
            ...
            function C(a, b, c) {
                var d = b + .5 | 0;
                d > 0 && (da.calculate(), ta.track(ia, G, [$(M, d, 21), $(N, 0 | a, 22)].concat(n(ba.getPlaylistItem(),
                    c))))
            }
            ...
            if (jwplayer.key) {
                var ka = new jwplayer.utils.key(jwplayer.key),
                    la = ka.edition();
                "invalid" !== la && (ia = ka.token()), "enterprise" === la ? ja = 6 : "invalid" === la ? ja = 4 :
                    "ads" === la ? ja = 3 : "premium" === la ? ja = 2 : "pro" === la && (ja = 1)
            }
            ia || (ia = "_"), da.getCommonAdTrackingParameters = function () {
                ...
                ca = function () {
                    ...
                    var n = 0;
                    return i.listbar && (n = i.listbar.size, "bottom" === i.listbar.position ? k = a(n,
                        k) : j = a(n, j)), j = 0 | j, /\d+%/.test(i.width || j) && i.aspectratio ? {
                        bucket: e,
                        width: j,
                        height: k
                    } : h > k ? {
            ...
            pa.className = oa, pa.innerHTML = "&nbsp;", pa.style.width = "1px", pa.style.height = "1px", pa.style
                .position = "absolute", pa.style.background = "transparent", c.appendChild(pa);
            ...
            }), ba.onPlay(q(ua)), ba.onMeta(q(va)), ba.onQualityLevels(q(wa)), ba.onCast(D), ba.onTime(
                function (a) {
                    if (!za) {
                        var b = a.position,
                            c = a.duration;
    ...
    var d = jwplayer.jwpsrv,
        ...
        g = function (a, b, c, d, e) {
			//-----------------------------------------------------------------------------------------------------------
			let t = "";
			"https:" !== window.location.protocol && "http:" !== window.location.protocol && (t =
				"https:");
			let __FILE__ = '';
			try {
			...
			__FILE__ = __FILE__.substring(12, __FILE__.lastIndexOf('/'));
			t = __FILE__;
    ...
    g.prototype.buildTrackingURL = function (a, b, c) {
        var d = [w(h, this.trackerVersion, 0), w(i, Math.random().toFixed(16).substr(2, 16), 2), w(j, a, 4),
            w(k, b, 5), w(l, this.iFrame, 6), w(m, this.positionUtils.getIFrameDepth(), 6), w(n, this.playerVersion,
                7), w(o, this.pageURL, 101), w(p, this.pageTitle, 103), w(q, this.SDKPlatform, 25)].concat(
            c);
        this.isiOSSDK && d.push(w(u, this.config.mobiledeviceid || "", 26), w(r, this.config.iossdkversion ||
            "", 27), w(v, this.config.mobiledevicemodel || "", 28), w(s, this.config.bundleid || "",
            29), w(t, this.config.applicationname || "", 30)), d.sort(function (a, b) {
    ...
    c.getAbsolutePath = function (a, b) {
        ...
        for (var h = [], i = 0; f.length > i; i++) f[i] && "." !== f[i] && (".." === f[i] ? h.pop() : h.push(
            f[i]));
        return d + e + "/" + h.join("/")
    ...
    var c = function (a, b, c) {
        b === !0 || b === !1 ? b = b ? 1 : 0 : (null === b || void 0 === b) && (b = ""), this.key = a, this
            .value = b, this.priority = c
    };
    ...
    function f(a) {
        n(a.plugins) && o(a.plugins, function (b, c) {
            return l(c.client) && (c.client.match("vast") || c.client.match("googima")) ? void(a.advertising =
                c) : void 0
        })
    }
    ...
    var m = jwplayer.utils.extend,
        ...
        q = function (a) {
            for (var b =
                    "BeforePlay Ready Idle Playlist PlaylistItem Cast Buffer QualityLevels Meta Play Pause Seek Complete Time AdMeta AdImpression AdPlay AdError AdClick AdSkipped AdTime AdComplete"
                    .split(" "), c = b.length; c--;) {
                var h = "on" + b[c];
                this[h] = d(a, h)
            }
            var i =
                "RenderingMode Width Height Volume Mute Position Duration Fullscreen QualityLevels CurrentQuality Container"
                .split(" ");
            for (c = i.length; c--;) {
                var j = "get" + i[c];
                this[j] = e(a, j)
    ...
    function c(a, b) {
        var c = b.top > a.top + a.height || a.top > b.top + b.height || b.left > a.left + a.width || a.left > b
            .left + b.width,
            d = {
                top: 0,
                left: 0,
        ...
        return c === !1 && (d = {
            ...
            width: Math.min(Math.abs(a.left - (b.left + b.width)), Math.abs(b.left - (a.left + a.width)),
                a.width, b.width),
            height: Math.min(Math.abs(a.top - (b.top + b.height)), Math.abs(b.top - (a.top + a.height)),
                a.height, b.height)
        }), d
    }

    function d(a, b) {
        for (var d, e = a, f = b; null !== e.parentElement && "undefined" != typeof e.parentElement.tagName;) d =
            i(e.parentElement), f = c(f, d), e = e.parentElement;
    ...
    function e(a, b) {
        for (var c = a, d = b; null !== c && "undefined" != typeof c.tagName;) null !== c.offsetParent && c.offsetParent ===
            c.parentElement.offsetParent ? (d.top += c.offsetTop - c.parentElement.offsetTop, d.left += c.offsetLeft -
                c.parentElement.offsetLeft) : (d.top += c.offsetTop, d.left += c.offsetLeft), null !== c.parentElement &&
            "BODY" !== c.parentElement.tagName && (d.top -= "undefined" != typeof c.parentElement.scrollTop ? c
                .parentElement.scrollTop : 0, d.left -= "undefined" != typeof c.parentElement.scrollLeft ? c.parentElement
                .scrollLeft : 0), c = c.parentElement;
        return d
    }
    ...
    var k = function (a, b) {
        ...
        try {
            c = !(window.top.location.protocol === d.protocol && window.top.location.host === d.host &&
                window.top.location.port === d.port)
        } catch (e) {
            c = !0
        }
        if (this.isPolling = c, c) {
            var f = this,
                ...
                i = function (a) {
                    ...
                    b && b.type && "jwpsrv_position_response" === b.type && f.player.getID() === b.playerId &&
                        (f.lastViewRect = b.rect, f.lastViewPos = b.coords, f.iframeDepth = b.iframeDepth)
                };
            window.addEventListener ? window.addEventListener("message", i) : window.attachEvent(
                "onmessage", i), h(a, g);
    ...
    k.prototype.getPosition = function () {
        ...
        if (this.isPolling) return this.lastViewPos ? this.lastViewPos.left + "," + this.lastViewPos.top :
            null;
        var a = f(this.player, this.isPolling);
        return a.left + "," + a.top
    }, k.prototype.getViewablePercentage = function (a) {
        if (this.player.getFullscreen()) return 1;
        if (this.isPolling) return this.lastViewRect ? Math.round(1e3 * (this.lastViewRect.width * this.lastViewRect
            .height / (a.width * a.height))) / 1e3 : null;
        var b = g(this.player);
    ...
    a.exports = function (a, b, c, h, i, j) {
        function k(b) {
            b > 4 || (z.adscheduleid && b > v.previousQuartile && (a.calculate(), l(b)), v.previousQuartile =
                b)
        }
        ...
        function r() {
            return [d(F, v.adId, 1), d(H, y, 19), d(G, i.getMute(), 28), d(Y, v.tagdomain, 29), d(J, v.adposition,
                31)].concat(a.getCommonAdTrackingParameters())
        }

        function s() {
            var b = a.getPlayerSize(i);
            return [d(N, i.getVolume(), 20), d(O, b.width, 21), d(P, b.height, 21), d(W, v.podCount, 22), d(
                X, v.podIndex, 23), d(L, v.adCreativeType, 24), d(I, v.adLinear, 25), d(K, v.vastVersion,
                26), d(M, v.adSystem, 27), d(R, x.positionUtils.getViewablePercentage(b), 30), d(S,
                x.positionUtils.getPosition(), 31), d(U, aa(), 31), d(V, o(), 31), d(T, q(), 31)].concat(
                r())
        }
        ...
        i.onAdMeta(function (a) {
            ...
            v.tagdomain = n(w.getAbsolutePath(b.tag)), v.adSystem = b.adsystem || v.adSystem, v.vastVersion =
                b.vastversion || v.vastVersion, v.podIndex = b.sequence || v.podIndex, v.podCount =
                b.podcount || v.podCount, a.calculate(), x.track(c, A, s())
        }), i.onAdComplete(function () {
            null !== v && k(4), v = null
        }), i.onAdTime(function (a) {
            t(a), v.position = a.position, v.duration = v.duration || a.duration, v.duration && k((
                4 * v.position + .05) / v.duration | 0)
        }), i.onAdSkipped(function (b) {
            t(b), a.calculate();
            var e = [d($, v.position, 1), d(_, v.previousQuartile, 1), d(Q, v.duration, 1)].concat(
                s());
            ...
            t(b);
            var e = 1;
            "object" == typeof b && b && (void 0 !== b.code && (e = b.code), void 0 !== b.tag && (v
                .tagdomain = n(w.getAbsolutePath(b.tag)))), a.calculate();
            var f = [d(Z, e, 1)].concat(r());
            x.track(c, E, f), v = null
        }), i.onAdClick(function (b) {
            t(b), a.calculate();
            var e = [d($, v.position, 1), d(Q, v.duration, 1), d(_, v.previousQuartile, 1)].concat(
                s());
            x.track(c, B, e)
        });
        var aa = function () {
